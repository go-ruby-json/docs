...
Contributions are welcome. `go-ruby-json/json` is built to a small set of non-negotiable
...
The library is in
[`github.com/go-ruby-json/json`](https://github.com/go-ruby-json/json). This documentation site is in
[`github.com/go-ruby-json/docs`](https://github.com/go-ruby-json/docs). Start from the
