...
`go-ruby-json/json` reimplements Ruby's JSON in **pure Go, with cgo disabled**. The
...
- any Go program can import `github.com/go-ruby-json/json` directly, with no Ruby runtime;
